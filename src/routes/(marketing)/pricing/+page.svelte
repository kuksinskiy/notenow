...
<div class="px-4 py-8 container mx-auto">
	...
	<section class="mb-20">
		<div class="max-w-6xl gap-8 md:grid-cols-3 mx-auto grid grid-cols-1">
			{#each pricingData.plans as plan, index}
				<div
					class="card bg-base-100 border-base-200 rounded-md shadow-md overflow-hidden border {plan.popular
						? 'relative'
						: ''}"
				>
					{#if plan.popular}
						<div
							class="bg-primary text-primary-content top-0 right-0 rounded-bl-md px-3 py-1 text-sm font-medium absolute"
						>
							Most Popular
						</div>
					{/if}
					...
					<div class="card-body p-6">
						...
						<div class="card-actions">
							<a
								href={plan.ctaLink}
								class="btn {plan.popular ? 'btn-primary' : 'btn-outline'} rounded-md w-full"
							>
								{plan.cta}
							</a>
						</div>
	...
	<section class="mb-16 max-w-3xl mx-auto">
		<h2 class="mb-8 text-3xl font-bold text-center">Frequently Asked Questions</h2>
	...
	<section class="card bg-base-200 max-w-3xl rounded-md p-8 mx-auto text-center">
